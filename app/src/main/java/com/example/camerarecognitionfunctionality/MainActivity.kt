package com.example.camerarecognitionfunctionality
...
import com.example.camerarecognitionfunctionality.databinding.ActivityMainBinding
import com.example.camerarecognitionfunctionality.ml.AutoModel3
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //to direct user to google search
        ...
        //to download image when longpress on the image view
    ...
    private fun downloadImage(mBitmap: Bitmap):Uri? {
        val contentValues = ContentValues().apply {
            put(
                ...
                "Plant_Images" + System.currentTimeMillis() / 1000
            )
